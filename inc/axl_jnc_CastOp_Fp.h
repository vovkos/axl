...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_FpTrunc, ICastOperator)
...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_FpExt, ICastOperator)
...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_FpFromInt, ICastOperator)
...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_FpFromInt_u, ICastOperator)
...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_FpFromBeInt, ICastOperator)
...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_FpFromEnum, ICastOperator)
...
{
public:
	AXL_OBJ_SIMPLE_CLASS (CCast_Fp, ICastOperator)
