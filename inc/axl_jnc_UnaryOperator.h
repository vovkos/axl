...
public:
	...
	static
	llvm::Instruction*
	LlvmOpInt (llvm::Value* pOpValue)
	{
		return llvm::BinaryOperator::CreateNeg (pOpValue);
	}

	static
	llvm::Instruction*
	LlvmOpFp (llvm::Value* pOpValue)
	{
		return llvm::BinaryOperator::CreateFNeg (pOpValue);
	}
};
...
public:
	...
	LlvmOpInt (llvm::Value* pOpValue)
	{
		return llvm::BinaryOperator::CreateNot (pOpValue);
	}
};
