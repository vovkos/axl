...
class CLuaState: public rtl::CHandleT <lua_State*, NULL, CLuaClose>
{
public:
	CLuaState ()
	{
	...
	{
		ASSERT (IsOpen ());
		lua_pushcclosure (m_h, pfn, ContextArgumentCount);
	}	

	void
	PushFunction (lua_CFunction pfn)
	{
		ASSERT (IsOpen ());
		lua_pushcfunction (m_h, pfn);
	}	
