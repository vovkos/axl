...
public:
	...
	CHashTableIteratorT (const CHashTableIteratorT& Src)
	{ 
		m_p = Src.m_p; 
	}
...
public:
	...
	CHashTableMapIteratorT (const CHashTableMapIteratorT& Src)
	{ 
		m_p = Src.m_p; 
	}
...
public:
	...
	{ 
		...
		CBucket::CIterator It = pBucket->GetHead ();
		for (; It; It++)
		{
	...
	#else
		size_t LoadFactor = (size_t) ((ulonglong_t) GetCount () * 100 / BucketCount);
	#endif
