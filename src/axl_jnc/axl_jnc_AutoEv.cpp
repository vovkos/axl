...
CAutoEv::Create (CAutoEvType* pType)
{
	...
	m_pDataStructType->m_Tag = m_Tag + ".Data";
...
CAutoEv::CreateVTablePtr ()
{
	...
	VariableTag.Format ("%s.vtbl", GetQualifiedName ().cc ()); // thanks a lot gcc
