...
const uint8_t g_thunkCode[] =
	{
		...
		0x48, 0x8B, 0x95, 0x28, 0xFF, 0xFF,
		0xFF,        // 0000010E  mov     rdx,  [rbp - RegArgBlockSize - 16 * 2 - 8 * 1]
		0x48, 0x8B, 0x85, 0x20, 0xFF, 0xFF,
		0xFF,        // 00000115  mov     rax,  [rbp - RegArgBlockSize - 16 * 2 - 8 * 2]
		0xC3,                                            // 0000011C  ret
		...
		0x66, 0x0F, 0x7F, 0x8D, 0x40, 0xFF, 0xFF,
		0xFF,  // 0000012C  movdqa  [rbp - RegArgBlockSize - 16 * 1],         xmm1
		0x66, 0x0F, 0x7F, 0x85, 0x30, 0xFF, 0xFF,
		0xFF,  // 00000134  movdqa  [rbp - RegArgBlockSize - 16 * 2],         xmm0
		0x48, 0x89, 0x95, 0x28, 0xFF, 0xFF,
		0xFF,        // 0000013C  mov     [rbp - RegArgBlockSize - 16 * 2 - 8 * 1], rdx
		0x48, 0x89, 0x85, 0x20, 0xFF, 0xFF,
		0xFF,        // 00000143  mov     [rbp - RegArgBlockSize - 16 * 2 - 8 * 2], rax
		...
		0x48, 0x8B, 0x95, 0x28, 0xFF, 0xFF,
		0xFF,        // 0000017A  mov     rdx,  [rbp - RegArgBlockSize - 16 * 2 - 8 * 1]
		0x48, 0x8B, 0x85, 0x20, 0xFF, 0xFF,
		0xFF,        // 00000181  mov     rax,  [rbp - RegArgBlockSize - 16 * 2 - 8 * 2]
