...
{
	EPgError_Success = 0,
	EPgError_NoGrammarFile,	
	EPgError_InvalidSwitch,			
	EPgError_FrameCountMismatch,
	EPgError_ParseFailure,
	EPgError_BuildFailure,
	EPgError_GenerateFailure,
};
...
{
	printf (
		"Tibbo LL (k) parser generator\n"
		"Usage:\n"
		"till [options] <grammar_file>\n"
...
#endif
{
	...
	if (!TargetList.IsEmpty ())
	{
		...
		{
			printf ("%s\n", err::GetError ()->GetDescription ().cc ()); 
			return EPgError_GenerateFailure;
		}
	}
