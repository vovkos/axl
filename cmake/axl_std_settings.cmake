...
axl_apply_gcc_settings)
	...
	if(NOT APPLE)
		if(GCC_LINK_EXPORTLESS_EXE)
			set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,--version-script='${AXL_CMAKE_RES_DIR}/exportless-exe.version'")
		endif()
...
axl_print_std_settings)
	...
	axl_message("        Version:"       ${CMAKE_C_COMPILER_VERSION})
	axl_message("        Debug flags:"   ${_C_FLAGS_DEBUG})
	axl_message("        Release flags:" ${_C_FLAGS_RELEASE})
