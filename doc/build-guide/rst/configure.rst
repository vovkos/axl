...
However, there is an important difference with most CMake-based projects. AXL build system does not rely on CMake ``find_package`` facility to find dependencies. Why not?
