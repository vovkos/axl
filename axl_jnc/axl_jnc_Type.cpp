...
GetTypeModifierString (ETypeModifier Modifier)
{
	static const tchar_t* StringTable [] = 
	{
		...
		_T("property"),      // ETypeModifier_Property  = 0x00001000,
		_T("bindable"),      // ETypeModifier_Bindable  = 0x00002000,
		_T("autoget"),       // ETypeModifier_AutoGet   = 0x00004000,
		_T("indexed"),       // ETypeModifier_Indexed   = 0x00008000,
		_T("nonull"),        // ETypeModifier_NoNull_p  = 0x00010000,
		_T("const"),         // ETypeModifier_Const_p   = 0x00020000,
		_T("weak"),          // ETypeModifier_Weak_p    = 0x00040000,
		_T("unsafe"),        // ETypeModifier_Unsafe_p  = 0x00080000,
		_T("event"),         // ETypeModifier_Event     = 0x00100000,
	};
