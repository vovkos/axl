...
GetTypeModifierString (ETypeModifier Modifier)
{
	static const tchar_t* StringTable [] = 
	{
		...
		_T("mutable"),       // ETypeModifier_Mutable    = 0x00000040,
		_T("volatile"),      // ETypeModifier_Volatile   = 0x00000080,
		_T("weak"),          // ETypeModifier_Weak       = 0x00000100,
		_T("thin"),          // ETypeModifier_Thin       = 0x00000200,
		_T("unsafe"),        // ETypeModifier_Unsafe     = 0x00000400,
		_T("cdecl"),         // ETypeModifier_Cdecl      = 0x00000800,
		_T("stdcall"),       // ETypeModifier_Stdcall    = 0x00001000,
		_T("class"),         // ETypeModifier_Class      = 0x00002000,
		_T("function"),      // ETypeModifier_Function   = 0x00004000,
		_T("property"),      // ETypeModifier_Property   = 0x00008000,
		_T("autoev"),        // ETypeModifier_AutoEv     = 0x00010000,
		_T("bindable"),      // ETypeModifier_Bindable   = 0x00020000,
		_T("autoget"),       // ETypeModifier_AutoGet    = 0x00040000,
		_T("indexed"),       // ETypeModifier_Indexed    = 0x00080000,
		_T("nonull"),        // ETypeModifier_Nullable_p = 0x00100000,
		_T("const"),         // ETypeModifier_Const_p    = 0x00200000,
		_T("weak"),          // ETypeModifier_Weak_p     = 0x00400000,
		_T("unsafe"),        // ETypeModifier_Unsafe_p   = 0x00800000,
		_T("event"),         // ETypeModifier_Event      = 0x01000000,
	};
