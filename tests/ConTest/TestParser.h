...
public:
 ...
 #line 11 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.llk"
			
			printf ("spec:byte\n");
		;
 #line 287 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.h"
			}
		...
		case 1:
			...
			CSymbolNode* __pSymbol = GetSymbolTop ();
			CAstNode* __pAstNode = __pSymbol->m_pAstNode;
 #line 16 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.llk"
			
			printf ("spec:property %s {}\n", (*GetTokenLocator (0)).m_Data.m_String);
		;
 #line 300 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.h"
			}
		...
		case 2:
			...
			CSymbolNode* __pSymbol = GetSymbolTop ();
			CAstNode* __pAstNode = __pSymbol->m_pAstNode;
 #line 23 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.llk"
			
			printf ("mod:property\n");
		;
 #line 313 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.h"
			}
		...
		case 3:
			...
			CSymbolNode* __pSymbol = GetSymbolTop ();
			CAstNode* __pAstNode = __pSymbol->m_pAstNode;
 #line 27 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.llk"
			
			printf ("mod:const\n");
		;
 #line 326 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.h"
			}
		...
		case 4:
			...
			CSymbolNode* __pSymbol = GetSymbolTop ();
			CAstNode* __pAstNode = __pSymbol->m_pAstNode;
 #line 39 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.llk"
			
			printf ("decl:id %s\n", (*GetTokenLocator (0)).m_Data.m_String);
		;
 #line 339 "D:/Prj/Ninja/axl3/test/ConTest/TestParser.h"
			}
